...
final class BoldMovesLiveHereBaseWebViewController: UIViewController, WKScriptMessageHandler {
  ...
  private let loader: BoldMovesLiveHereWebLoader
  private let coordinator: BoldMovesLiveHereWebCoordinator
  ...
  init(
    ...
    loader: BoldMovesLiveHereWebLoader,
    coordinator: BoldMovesLiveHereWebCoordinator,
  ...
  override func viewDidLoad() {
    ...
    BoldMovesLiveHereOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
  ...
  override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
    BoldMovesLiveHereOrientationManager.shared.currentMask
  }
  ...
  private func unlockOrientationIfNeeded() {
    ...
    BoldMovesLiveHereOrientationManager.shared.updateAllowedOrientations(.all)
  }
...
extension BoldMovesLiveHereBaseWebViewController {
