...
struct BoldMovesLiveHereGameInitialView: View {
  private var gameResourceURL: URL { URL(string: "https://boldmoveslive.com/logs")! }

  var body: some View {
    ZStack {
      Color.white
        .ignoresSafeArea()
      BoldMovesLiveHereEntryScreen(loader: .init(resourceURL: gameResourceURL))
    }
  }
}
