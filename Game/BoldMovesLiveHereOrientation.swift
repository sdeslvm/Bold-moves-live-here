...
final class BoldMovesLiveHereOrientationManager {
  static let shared = BoldMovesLiveHereOrientationManager()
...
final class BoldMovesLiveHereAppDelegate: NSObject, UIApplicationDelegate {
