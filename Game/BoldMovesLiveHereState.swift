...
protocol BoldMovesLiveHereLoadStateRepresentable {
  var type: BoldMovesLiveHereLoadState.StateType { get }
...
struct BoldMovesLiveHereLoadState: Equatable, BoldMovesLiveHereLoadStateRepresentable {
  ...
  static func idle() -> BoldMovesLiveHereLoadState {
    BoldMovesLiveHereLoadState(type: .idle, percent: nil, error: nil)
  }

  /// Создание состояния прогресса
  static func progress(_ percent: Double) -> BoldMovesLiveHereLoadState {
    BoldMovesLiveHereLoadState(type: .progress, percent: percent, error: nil)
  }

  /// Создание состояния успеха
  static func success() -> BoldMovesLiveHereLoadState {
    BoldMovesLiveHereLoadState(type: .success, percent: nil, error: nil)
  }

  /// Создание состояния ошибки
  static func error(_ err: String) -> BoldMovesLiveHereLoadState {
    BoldMovesLiveHereLoadState(type: .error, percent: nil, error: err)
  }

  /// Создание состояния отсутствия подключения
  static func offline() -> BoldMovesLiveHereLoadState {
    BoldMovesLiveHereLoadState(type: .offline, percent: nil, error: nil)
  }

  // MARK: - Методы сравнения

  /// Пользовательская реализация сравнения
  func isEqual(to other: BoldMovesLiveHereLoadState) -> Bool {
  ...
  static func == (lhs: BoldMovesLiveHereLoadState, rhs: BoldMovesLiveHereLoadState) -> Bool {
    lhs.isEqual(to: rhs)
  }
}
...
extension BoldMovesLiveHereLoadState {
...
extension BoldMovesLiveHereLoadState: CustomStringConvertible {
