...
class BoldMovesLiveHereWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
  private let callback: (BoldMovesLiveHereWebStatus) -> Void
  private var didStart = false

  init(onStatus: @escaping (BoldMovesLiveHereWebStatus) -> Void) {
