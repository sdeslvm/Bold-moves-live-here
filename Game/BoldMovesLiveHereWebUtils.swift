...
enum BoldMovesLiveHereWebStatus: Equatable, WebStatusComparable {
  case standby
  ...
  func isEquivalent(to other: BoldMovesLiveHereWebStatus) -> Bool {
    switch (self, other) {
...
extension BoldMovesLiveHereWebStatus {
...
extension BoldMovesLiveHereWebStatus {
  static func == (lhs: BoldMovesLiveHereWebStatus, rhs: BoldMovesLiveHereWebStatus) -> Bool {
